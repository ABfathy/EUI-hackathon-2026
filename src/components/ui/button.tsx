...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-[5px] whitespace-nowrap font-medium cursor-default select-none transition-[color,background-color,border-color,transform,scale] duration-fast ease-out-app active:scale-[0.96] disabled:cursor-not-allowed disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-ring",
  {
    variants: {
      variant: {
        default:
